...
const STAY_HOTEL_BY_DAY = {
  ...
  day14: "Keio Plaza Hotel Tokyo",
  day15: "Keio Plaza Hotel Tokyo",
  day16: "Keio Plaza Hotel Tokyo",
  day17: "Tokinoyu Setsugetsuka",
  day18: "Tokinoyu Setsugetsuka",
  day19: "Tokinoyu Setsugetsuka",
  day20: "Keio Plaza Hotel Tokyo",
  day21: "Keio Plaza Hotel Tokyo"
};
...
const roadmapGoals = [
  ...
  { id: "mountain-chapter", goal: "Three-night Hakone retreat", days: ["day17", "day18", "day19"], status: "Needs Route Checks", why: "The confirmed Gora hotel beside the station makes the mountain chapter usable by scheduled transport, with Mai's sunrise shrine visit, the reverse classic loop and a real hiking day.", blocker: "Prebook the Nov 9 05:30 taxi, resolve the hotel-breakfast conflict, and recheck the November bus/cruise/ropeway timetable, Mount Kintoki trail conditions and exact hotel meal times.", fallback: "Use the earliest public-transport route to Moto-Hakone if the taxi cannot be arranged; use the H bus and Tozan train to return to Gora if the loop is cancelled." },
  ...
  { id: "friends-day", goal: "Evening with Akko", days: ["day16"], status: "Needs Confirmation", why: "The social evening is the protected capstone. Shinjuku puts the Keio Line to Chofu at the hotel door, so the Shibuya day can still end early enough for wherever Akko chooses.", blocker: "Confirm meeting point, time, and whether Yoshi is joining.", fallback: "Leave Shibuya by 15:30, or return to Shinjuku for the direct Keio ride to Chofu, and keep dinner seated and unhurried." },
  { id: "asakusa-hall", goal: "Asakusa Engei Hall for Mai", days: ["day20"], status: "Needs Schedule Check", why: "A short yose visit adds rakugo and variety entertainment without taking over the Hakone return day.", blocker: "Check the Nov 11 bill when it is published about one month ahead; special programs can change the normal hours.", fallback: "If the return reaches Shinjuku after 14:00, skip the hall and protect luggage, rest, and dinner. The hotel is now a five-minute walk from the Romancecar platforms." },
...
const tripData = {
  ...
  tokyo: {
    name: "Tokyo",
    baseLabel: "Keio Plaza Hotel Tokyo",
    description: "West Shinjuku bookends a three-night Hakone retreat: settle in after Hiroshima, leave large bags while Mai and Brian go to Gora, return for one Tokyo night (Nov 11–12), then spend Nov 12 moving around the city with bags stored before the 01:00 Haneda flight.",
    ongoing: [
      {
    ...
    days: [
      questDay("day14", "2026-11-05", "Ekiben Eastbound", "The long Shinkansen becomes the experience: browse, choose, reveal, share, score, then settle into Tokyo.", ["Hiroshima Station", "Tokyo Station", "Keio Plaza Hotel Tokyo"], "Turn Hiroshima-to-Tokyo into the main ekiben tasting and a calm move into the Tokyo neighborhood.", ["Arrive early enough to browse", "Choose different regional boxes", "Photograph closed packages and open trays", "Trade tastes after departure", "Score all five categories", "Learn the Tokyo hotel station exit, konbini, and easiest dinner"], ["An unexpected bento ingredient", "A beautiful wrapper or clever compartment", "A train-window scene worth pausing lunch for"], "Train food becomes one of the day's actual memories and Tokyo begins gently.", "No Tokyo sightseeing is required after arrival."),
      questDay("day15", "2026-11-06", "Kichijoji Without the Museum", "Soft imaginative Tokyo while Ghibli Museum is closed.", ["Keio Plaza Hotel Tokyo", "Inokashira Park", "Kichijoji Sunroad Shopping District"], "Accept the Nov 4–17 museum closure and make the park, cafes and Kichijoji the complete quest.", ["Walk by the pond", "Find a cafe that belongs in this day", "Browse one shotengai", "Choose a snack or object animated in spirit", "Check bakeries for a new melon-bread style"], ["A duck, bridge, or pond reflection", "A handmade-looking display", "A detail that rewards looking closely"], "Mai gets why Tokyo is not just skyscrapers.", "Do not build the day around a museum that is closed."),
      questDay("day16", "2026-11-07", "Scramble Into Their Tokyo", "Give Dad his Shibuya moment, one Mai-friendly pop-culture stop, then protect the evening with Akko.", ["Keio Plaza Hotel Tokyo", "Shibuya Crossing", "Hachiko Statue", "Shibuya PARCO", "Akko meetup · provisional Chofu Station"], "Cross the Scramble, take the Hachiko photo, eat lunch nearby, choose one compact Mai stop, and leave by 15:30 on the Keio Line toward Akko.", ["Cross Shibuya Crossing together", "Take Dad's Hachiko or crossing photo", "Choose one rooftop, cafe, or people-watching view", "Give Mai one focused PARCO or character-culture stop", "Leave by 15:30 via Keio from Shibuya/Meidaimae or Shinjuku", "Bring a small consumable thank-you gift for Akko"], ["Dad in the crossing", "Hachiko or Shibuya street texture", "The relaxed group dinner with Akko"], "Dad gets his Tokyo icon and Mai gets one playful stop without exhausting the social evening.", "Cross once, take the photo, and skip PARCO if the meetup requires an earlier departure."),
      questDay("day17", "2026-11-08", "Into Hakone", "Tokyo intensity gives way to three confirmed nights at Setsugetsuka, one minute from Gora Station.", ["Shinjuku Station", "Hakone-Yumoto Station", "Gora Station", "Tokinoyu Setsugetsuka", "Hakone Open-Air Museum"], "Leave large luggage at Keio Plaza, walk to the Odakyu Romancecar with small bags, ride the mountain railway, leave bags at Setsugetsuka, then use the Open-Air Museum before the 15:00 check-in.", ["Reserve the Romancecar to Hakone-Yumoto", "Keep medication and layers in the small bag", "Take the Hakone Tozan Railway to Gora", "Walk one minute from Gora Station to the hotel", "Leave bags before the 15:00 check-in", "Give the museum 90–120 minutes before its 17:00 close", "Use only the room bath or a private bath"], ["The mountain railway", "A sculpture against the hills", "The first private-bath evening"], "Mai gets a mountain retreat whose transport begins at the hotel door.", "Parents remain in Tokyo and their Nov 10 Haneda departure is confirmed."),
      ...
      questDay("day20", "2026-11-11", "Back to Tokyo, Into the Yose", "Return from Hakone by rail, reunite with the luggage, then give Mai a compact dose of old-school Japanese variety entertainment.", ["Tokinoyu Setsugetsuka", "Gora Station", "Hakone-Yumoto Station", "Shinjuku Station", "Keio Plaza Hotel Tokyo", "Asakusa Engei Hall"], "Take the protected morning train return, recover the large bags, then visit Asakusa Engei Hall for 60–90 minutes only if the transfer lands on time.", ["Leave Gora early for Hakone-Yumoto", "Use the reserved Romancecar to Shinjuku", "Recover the large luggage and check in", "Check the Asakusa Engei Hall bill and stage times", "Watch a compact rakugo or variety segment with Mai", "Eat an easy Asakusa or hotel-neighborhood dinner"], ["The last mountain railway view", "Suitcases reunited", "Asakusa yose curtain or lanterns"], "Mai gets a living traditional entertainment hall while the day still functions as a soft landing.", "If the Hakone return runs late, protect luggage and rest; Asakusa becomes optional."),
      questDay("day21", "2026-11-12", "Light, Melon Bread, Goodbye", "Checkout at 10:00, store the suitcases, then spend the day in Tokyo before the late Haneda flight.", ["Keio Plaza Hotel Tokyo", "teamLab Borderless Azabudai Hills", "Tokyo Melonpan", "Final Tokyo Dinner", "Haneda Airport"], "Check out of the return hotel by 10:00, leave large bags at the front desk or a Shinjuku luggage room (coin lockers are often too small), visit teamLab and Mai's melon-bread shop hands-free, eat a final meal, retrieve the bags, and reach Haneda that evening for the 01:00 Nov 13 flight.", ["Check out by 10:00 and store the large bags", "Find the teamLab room we most want to remember", "Take one abstract photo", "Confirm the exact bakery branch and stock", "Score the special melon bread in the passport", "Eat the final this-is-Tokyo meal", "Retrieve bags with airport margin", "Be at Haneda by about 22:00 for the 01:00 flight"], ["A reflection that changes the room", "The first crackle of the special melon-bread crust", "One tiny goodbye photo"], "Mai chooses the sweet and emotional ending of the trip.", "Mom and Dad departed from Haneda on Nov 10; this is a couple-only final day with no hotel that night.")
    ]
  }
};
...
const dayGoals = {
  ...
  day14: {
    clearPath: "Ekiben browse, score, and ride east—then JR to Shinjuku and the walk to Keio Plaza.",
  ...
  day17: {
    clearPath: "Small bags only: walk to the Odakyu Romancecar, ride to Hakone-Yumoto, mountain railway to Gora, one-minute walk to Setsugetsuka, optional Open-Air Museum.",
  ...
  day21: {
    clearPath: "10:00 checkout → store bags → teamLab and melon bread → retrieve bags → Haneda evening.",
...
const dayContext = {
  ...
  day14: {
    ...
    timeline: [["08:30–10:00", "Check out and reach Hiroshima Station early enough to browse regional ekiben calmly."], ["10:00–14:30", "Ride east, photograph closed and open boxes, trade tastes, score them, and watch the country change."], ["15:00–17:30", "From Tokyo Station take the JR Chuo or Yamanote Line to Shinjuku, walk five minutes to Keio Plaza, and fully settle in."], ["Evening", "Choose a depachika, supermarket, ramen, or curry dinner near Shinjuku West Exit; add no sightseeing campaign."]],
    history: [
  ...
  day15: {
    ...
    timeline: [["Morning", "Take the JR Chuo Line from Shinjuku to Kichijoji; there is no museum deadline."], ["Late morning–14:00", "Walk Inokashira Park and pause at a cafe."], ["14:00–17:00", "Browse one Kichijoji shopping street, bakery, or small creative shop."], ["Evening", "Eat nearby or return to the hotel; the neighborhood itself is the complete day."]],
    history: [
  ...
  day16: {
    ...
    timeline: [["09:30–10:15", "Walk to JR Shinjuku and ride two Yamanote stops to Shibuya; no early alarm after the Kichijoji day."], ["10:15–11:15", "See Hachiko, cross the Scramble, watch one full signal cycle, and take Dad's group photo."], ["11:15–13:30", "Have a seated lunch, then choose exactly one Mai-facing stop; Shibuya PARCO is the default."], ["13:30–15:15", "Use a cafe/rest buffer or one short Shibuya browse—Harajuku is optional only if energy is high and the 15:30 exit still holds."], ["By 15:30", "Leave for Akko: Keio Inokashira to Meidaimae then Keio to Chofu, or return to Shinjuku for the direct Keio ride. Leave earlier if the confirmed point is farther than Chofu."], ["Evening", "Let Akko choose the neighborhood and dinner; keep it seated, social and unhurried."]],
    history: [
  ...
  day17: {
    summary: "Mai and Brian begin the confirmed three-night Hakone chapter with small bags while large luggage stays at Keio Plaza. Tokinoyu Setsugetsuka is one minute on foot from Gora Station, with 15:00 check-in and 11:00 check-out. MIYA HOUSE was cancelled at no cost on Aug 6; the exact Setsugetsuka room type, meal plan, price and cancellation terms still need to be copied from the reservation.",
    timeline: [["08:00–09:00", "Check out of the couple room, leave large bags at the Keio Plaza front desk, and walk to the Odakyu Romancecar platforms."], ["Morning–around noon", "Ride a reserved Romancecar to Hakone-Yumoto, then the Hakone Tozan Railway to Gora."], ["Around noon", "Walk about one minute from Gora Station to Tokinoyu Setsugetsuka and leave the small bags before check-in."], ["13:00–15:00", "Ride one stop to Chokoku-no-Mori and give the Open-Air Museum 90–120 minutes."], ["15:00 onward", "Check in, confirm the dinner sitting if meals are included, and use the in-room bath or a private bath; do not plan a public-bath visit."]],
    history: [
  ...
  day19: {
    ...
    slowTimeline: [["Morning", "Parents check out of Keio Plaza with the international-flight buffer required by their departure time."], ["Nov 10", "Take the hotel-door Airport Limousine Bus to Haneda, or Keikyu via Shinagawa if the bus timetable is poor."], ["Departure", "Parents fly from Haneda. This date is confirmed."]],
    history: [
  ...
  day20: {
    ...
    timeline: [["07:00–08:30", "Breakfast, checkout, walk to Gora Station and descend by the Hakone Tozan Railway."], ["Morning–around noon", "Connect at Hakone-Yumoto to the reserved Romancecar for Shinjuku."], ["Around noon–15:00", "Walk to Keio Plaza, recover the large bags, and complete check-in before sightseeing."], ["15:00–16:40", "Travel to Asakusa Engei Hall and check the posted bill."], ["16:40–18:10", "Watch roughly 60–90 minutes of the night program, leaving between acts if energy is fading."], ["After 18:10", "Eat an easy Asakusa or Shinjuku-neighborhood dinner; add no second Asakusa sightseeing circuit."]],
    slowTimeline: [["Morning", "Breakfast, checkout and use the same rail route to Shinjuku without adding stops."], ["Early afternoon", "Reach Keio Plaza, recover the large bags, check in, and make the hotel the rest base."], ["Evening", "Skip Asakusa if needed and make hotel rest the complete day."]],
    history: [
...
const CITY_FOOD_MAP_PROTOTYPE = {
  ...
  tokyo: [
    { name: "7-Eleven Nishi-Shinjuku 2-chome", type: "conbini", category: "conbini", typeLabel: "Closest useful 7-Eleven", area: "Hotel base · ~3 min south", price: "¥", note: "The most useful Seven on the walk between Keio Plaza and Shinjuku Station. Use it for breakfast, Seven Bank or the packaged-melonpan comparison.", coordinates: [35.68915, 139.69285] },
    { name: "Lawson Keio Mall Shinjuku", type: "conbini", category: "conbini", typeLabel: "Closest Lawson", area: "Hotel base · Shinjuku West Exit mall", price: "¥", note: "A practical Lawson on the underground walk from Shinjuku West Exit toward Keio Plaza. It is the easiest late fallback when everyone wants supplies rather than a restaurant.", coordinates: [35.69055, 139.6982], officialUrl: "https://www.lawson.co.jp/" },
    { name: "FamilyMart Nishi-Shinjuku Tocho-mae", type: "conbini", category: "conbini", typeLabel: "Closest useful FamilyMart", area: "Hotel base · Tocho-mae side", price: "¥", note: "The third-chain option beside Tocho-mae Station, one minute from the hotel. Use it when heading toward the Metropolitan Government Building or specifically comparing FamilyMart breakfast items.", coordinates: [35.69035, 139.69155] },
    { name: "Ningyocho Imahan Main Store", type: "restaurant", category: "sukiyaki", typeLabel: "Sukiyaki · east-Tokyo detour", area: "Ningyocho · reservation detour", price: "¥¥¥¥", note: "A historic, reservation-worthy wagyu sukiyaki meal, now a dedicated east-Tokyo trip from Shinjuku. Choose it only as a deliberate celebratory dinner, not a hotel-neighborhood fallback.", coordinates: [35.68577, 139.78349], officialUrl: "https://imahan-tokyo.com/official/" },
    { name: "Tempura Tsunahachi Main Store", type: "restaurant", category: "tempura", typeLabel: "Tempura · Shinjuku classic", area: "Hotel base · Shinjuku-dori", price: "¥¥¥", note: "A seated family-friendly tempura house a short walk from Shinjuku Station. Use it for an arrival-night or parent dinner without leaving west Tokyo.", coordinates: [35.6914, 139.7041], officialUrl: "https://www.tunahachi.co.jp/en/" },
    { name: "Kaneko Hannosuke Nihonbashi Main Store", type: "restaurant", category: "tempura", typeLabel: "Edo-style tendon · station option", area: "Nihonbashi / Mitsukoshimae", price: "¥¥", note: "A dramatic but affordable bowl of sesame-oil-fried Edomae tempura near Tokyo Station. Famous queues make this an off-peak Day 14 arrival lunch, not a Shinjuku neighborhood meal.", coordinates: [35.68633, 139.77491], officialUrl: "https://www.kanekohannosuke.com/" },
    { name: "Manten Sushi Nihonbashi", type: "restaurant", category: "edomae-sushi", typeLabel: "Edomae sushi · reservable omakase", area: "COREDO Muromachi 2", price: "¥¥¥", note: "The structured, beginner-friendly omakase candidate if the group wants a reserved sushi night. It is now an east-Tokyo detour from Shinjuku; choose Sushi no Midori on the Shibuya day when queues allow.", coordinates: [35.6872, 139.77461], officialUrl: "https://www.manten-sushi.com/" },
    ...
    { name: "Fukagawa-juku Tomioka Hachimangu", type: "restaurant", category: "fukagawa-meshi", typeLabel: "Fukagawa-meshi · local history", area: "Monzen-nakacho / Fukagawa", price: "¥¥", note: "Clam rice in its home neighborhood, now a dedicated east-Tokyo detour from Shinjuku. Pick it only for one old-Tokyo lunch; do not add it to a full sightseeing day.", coordinates: [35.67142, 139.79835], officialUrl: "https://www.gotokyo.org/en/destinations/eastern-tokyo/fukagawa/index.html" },
    { name: "Omoide Yokocho Shinjuku", type: "restaurant", category: "everyday-tokyo", typeLabel: "Neighborhood yakitori · easy dinner", area: "Hotel base · Shinjuku West Exit", price: "¥¥", note: "The practical arrival- or return-night meal the map needs: yakitori and small plates a few minutes from Keio Plaza. Choose a seated shop if smoke or standing counters would bother the parents.", coordinates: [35.69135, 139.69955], officialUrl: "https://www.shinjuku-omoide.com/" },
    ...
    { name: "Duncan Coffee Shop Keio Plaza", type: "cafe", category: "cafe", typeLabel: "Zero-travel hotel café", area: "Inside Keio Plaza · 2F", price: "¥¥", note: "The hotel coffee shop and easiest breakfast reset. Use it on a transfer morning or when the parents want a proper seat without beginning another neighborhood mission.", coordinates: [35.69006, 139.69264], officialUrl: "https://www.keioplaza.com/tokyo/restaurants/" },
    ...
    { name: "Yanagiya", type: "sweet", category: "taiyaki", typeLabel: "Taiyaki · east-Tokyo classic", area: "Ningyocho Amazake Yokocho", price: "¥", note: "One of Tokyo's classic taiyaki names, cooking each crisp fish-shaped cake in an individual iron mold. It is now an east-Tokyo detour from Shinjuku; use it only if a Nihonbashi walk happens, and let the line decide the timing.", coordinates: [35.68574, 139.78284], officialUrl: "https://www.nihonbashi-tokyo.jp/en/shops/" },
    { name: "Shigemori Eishindo", type: "sweet", category: "ningyo-yaki", typeLabel: "Ningyo-yaki · origin-neighborhood pick", area: "Ningyocho / Suitengu", price: "¥", note: "The origin neighborhood for the small molded cakes named for Ningyocho. Buy a few only if already east of Tokyo Station; otherwise compare with Asakusa's landmark-shaped version on Day 20.", coordinates: [35.68427, 139.78516], officialUrl: "https://www.ningyocho.or.jp/english/feature/index.html" },
    ...
    { name: "Tokyo Melonpan Asakusabashi", type: "sweet", category: "melonpan", typeLabel: "Melon bread finale · protected", area: "Day 20/21 · Asakusabashi West Exit", price: "¥", note: "Mai's named Tokyo Melonpan finale. From Shinjuku it sits on the Day 20 Asakusa corridor rather than beside the hotel; confirm this is her intended branch and check same-day stock before leaving teamLab.", coordinates: [35.69719, 139.78457], officialUrl: "https://tokyo-melonpan.net/" }
  ]
};
  ...
  host.innerHTML = `
    <div class="trip-route-map-frame">
      ...
      <svg class="route-map-layer" viewBox="50 30 590 355" role="img" aria-labelledby="tripMapTitle tripMapDesc">
        ...
        ${makeRouteCitySvg(370.3, 320.6, 10, -13, "start", "Tokyo", "Shinjuku · Nov 5–8 &amp; 11–13", "tokyo-1")}
...
const placeBackground = {
  ...
  "Haneda Airport": "Mom and Dad depart from Haneda on Nov 10. Mai and Brian fly HND at 01:00 on Nov 13: check out of the Nov 11 hotel by 10:00 on Nov 12, store suitcases, spend the day in Tokyo, then reach Haneda that evening (aim about 22:00).",
  ...
  "Shinjuku Station": "Shinjuku is one of the world's busiest rail nodes, a five-minute walk from Keio Plaza, and the launch point for the Odakyu Romancecar to Hakone-Yumoto. The Keio Line from here runs direct to Chofu for Akko. On Hakone days it is a short walk with small bags; on return day it is already the hotel neighborhood.",
