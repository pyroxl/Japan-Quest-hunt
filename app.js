...
const roadmapGoals = [
  ...
  { id: "mountain-chapter", goal: "Three-night Hakone retreat", days: ["day17", "day18", "day19"], status: "Needs Route Checks", why: "The confirmed Gora hotel beside the station makes the mountain chapter usable by scheduled transport, with Mai's dawn shrine visit, the reverse classic loop and a real hiking day.", blocker: "Prebook the Nov 9 early taxi, resolve the hotel-breakfast conflict, and recheck the November cruise/ropeway timetable, Mount Kintoki trail conditions and exact hotel meal times.", fallback: "Use the earliest public-transport route to Moto-Hakone if the taxi cannot be arranged; use Gora Park, the Open-Air Museum and Pola Museum if weather closes the high route." },
...
const tripData = {
  ...
  tokyo: {
    ...
    days: [
      ...
      questDay("day18", "2026-11-09", "Dawn Shrine, Reverse Hakone Loop", "Mai gets Hakone Shrine before the crowds, then Lake Ashi, Owakudani, the ropeway and cable car form one continuous return to Gora.", ["Tokinoyu Setsugetsuka", "Hakone Shrine", "Moto-Hakone Port", "Togendai Station", "Owakudani", "Sounzan Station", "Gora Station (Return)"], "Prebook a 06:15 taxi from Setsugetsuka to Hakone Shrine, visit the grounds in the quiet early hour, then complete the classic loop in reverse once the cruise begins.", ["Ask Setsugetsuka to prebook the 06:15 taxi", "Confirm whether the early start means missing hotel breakfast", "Reach Hakone Shrine around 06:45 and take the forest and lakeshore slowly", "Return after 08:15 if Mai wants an amulet or goshuin", "Take the first practical cruise from Moto-Hakone to Togendai", "Ride the ropeway through Owakudani to Sounzan", "Descend by cable car to Gora in time for the hotel meal"], ["Shrine gate in the empty cedar forest", "Lake Ashi in early light", "Ropeway over the autumn valley"], "Mai gets the early shrine visit she desperately wants instead of finding it at the crowded end of the day.", "If the taxi cannot be arranged, use the earliest train/bus route via Kowakidani and accept a later shrine arrival; if the high route closes, return by bus and use the Gora museums."),
...
const dayGoals = {
  ...
  day18: {
    clearPath: "06:15 prebooked taxi → dawn Hakone Shrine → Moto-Hakone cruise → Togendai → Owakudani → Sounzan → cable car to Gora.",
    mainGoal: "Give Mai a genuinely quiet shrine visit, then complete the classic Hakone loop in reverse.",
...
const legacyDayContext = {
  ...
  day18: {
    summary: "A prebooked early taxi gives Mai a quiet Hakone Shrine visit before the reverse loop links Lake Ashi, Owakudani, the ropeway and cable car back to Gora.",
...
const dayContext = {
  ...
  day18: {
    summary: "Mai's quiet Hakone Shrine visit is the non-negotiable anchor. Prebook a taxi from Setsugetsuka for about 06:15, reach the shrine around 06:45, then take the first practical Moto-Hakone cruise toward Togendai and complete the classic loop in reverse through Owakudani, Sounzan and Gora. The shrine grounds can be visited early, but the amulet and goshuin counter normally begins at 08:15. Confirm the exact November cruise, ropeway and cable-car times closer to the trip.",
    timeline: [["05:45–06:15", "Wake, dress and use a takeaway or room snack unless Setsugetsuka can provide an early-breakfast solution."], ["06:15–06:45", "Take the prebooked taxi from Setsugetsuka directly to Hakone Shrine."], ["06:45–08:15", "Visit the cedar approach, main shrine and lakeshore while they are quiet. Do not turn the torii photograph into a rushed queue objective."], ["08:15–first practical cruise", "Use the amulet/goshuin counter if Mai wants it, then walk back to Moto-Hakone and eat breakfast or have coffee near the lake."], ["Late morning", "Cruise from Moto-Hakone to Togendai, then take the ropeway toward Owakudani."], ["Midday–afternoon", "Pause at Owakudani, continue to Sounzan, and descend by cable car to Gora."], ["Evening", "Return in time for the assigned hotel meal if dinner is included, then use a private bath."], ["No-taxi fallback", "Take the earliest workable train and H-bus connection via Kowakidani. This preserves the shrine-first order but will not feel like dawn."]],
    history: [
...
const placeBackground = {
  ...
  "Hakone Shrine": "Hakone Shrine sits among cedars near Lake Ashi, historically tied to travelers crossing the old Tokaido. Mai's quiet early visit is now the Nov 9 anchor: prebook a taxi from Setsugetsuka for about 06:15, arrive around 06:45, and note that the amulet and goshuin counter normally starts at 08:15.",
