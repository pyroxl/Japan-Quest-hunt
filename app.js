...
const roadmapGoals = [
  ...
  { id: "mountain-chapter", goal: "Three-night Hakone retreat", days: ["day17", "day18", "day19"], status: "Needs Route Checks", why: "The confirmed Gora hotel beside the station makes the mountain chapter usable by scheduled transport, with the classic loop and a real hiking day.", blocker: "Recheck the November ropeway/cruise timetable, Mount Kintoki trail conditions and the exact hotel meal times.", fallback: "Use the Open-Air Museum, Gora Park and Pola Museum if weather closes the high route." },
...
const tripData = {
  ...
  tokyo: {
    ...
    days: [
      ...
      questDay("day18", "2026-11-09", "The Hakone Loop", "Cable car, ropeway, volcanic valley, Lake Ashi and shrine form one coherent public-transport circuit.", ["Gora Station", "Sounzan Station", "Owakudani", "Togendai Station", "Moto-Hakone Port", "Hakone Shrine", "Kowakidani Station", "Gora Station (Return)"], "Start early and complete the classic loop clockwise, then use the H bus to Kowakidani and the mountain railway back to Gora.", ["Check live ropeway, cruise and bus status", "Ride Gora→Sounzan→Owakudani before crowds build", "Pause for the volcanic landscape and black eggs if wanted", "Cruise from Togendai to Moto-Hakone", "Visit Hakone Shrine without turning the lakeshore into a race", "Return to Moto-Hakone, take the H bus to Kowakidani Station, then the train to Gora"], ["Ropeway over the valley", "Lake Ashi from the boat", "Shrine gate among cedars"], "The mountain is experienced as a connected landscape, not a set of taxi requests.", "If high transport closes, use Gora Park, the Open-Air Museum and Pola Museum."),
...
const dayGoals = {
  ...
  day18: {
    clearPath: "Gora cable car → Sounzan → Owakudani → Togendai → Moto-Hakone cruise → Hakone Shrine → H bus to Kowakidani → mountain railway to Gora.",
...
const dayContext = {
  ...
  day18: {
    summary: "The classic Hakone loop gives the mountain chapter a coherent full day: cable car, ropeway, Owakudani, the 25–40 minute Lake Ashi cruise, Hakone Shrine, H bus to Kowakidani and mountain railway back to Gora. Start early and check live service status because weather, crowding or volcanic conditions can interrupt the route.",
    timeline: [["08:00–09:00", "Walk to Gora Station and ride the cable car to Sounzan."], ["09:00–11:00", "Take the ropeway to Owakudani, explore the volcanic viewpoint, then continue to Togendai."], ["11:00–13:00", "Cruise 25–40 minutes from Togendai to Moto-Hakone and have lunch."], ["13:00–15:15", "Walk to Hakone Shrine and return to the Moto-Hakone bus area at a humane pace."], ["15:15–17:00", "Take the H bus toward Kowakidani Station, then the Hakone Tozan Railway to Gora. Allow an extra bus because crowding can prevent boarding."], ["Evening", "Return in time for the assigned hotel meal if dinner is included, then use a private bath."]],
    history: [
...
const placeBackground = {
  ...
  "Moto-Hakone Port": "Moto-Hakone is the useful cruise arrival for Hakone Shrine. The sightseeing cruise from Togendai takes roughly 25–40 minutes; return here after the shrine for the H bus toward Kowakidani.",
  "Hakone Shrine": "Hakone Shrine sits among cedars near Lake Ashi, historically tied to travelers crossing the old Tokaido. Visit after the cruise, then return to the Moto-Hakone bus area.",
