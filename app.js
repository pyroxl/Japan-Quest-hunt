...
const LOCKED_HOTELS = [
  ...
  { dates: "Tokyo · Nov 5–8 & Nov 11–13", note: "Nihonbashi Hamacho · 2 rooms Nov 5–8; rebook 1 room Nov 11–13 (parents fly home before second stay)", name: "KOKO HOTEL Premier Nihonbashi Hamacho", url: "https://koko-hotels.com/nihonbashi_hamacho/" },
...
const RESERVATION_COUNTDOWN = [
  ...
  { name: "Cancel & rebook second Tokyo stay", recommendedOn: "2026-07-25", target: "Nov 11–13", note: "Parents' return tickets land before the second Tokyo leg. Cancel the Nov 11–13 parent room and redo KOKO as 1 couple-only room.", url: "https://koko-hotels.com/nihonbashi_hamacho/" },
...
const roadmapGoals = [
  ...
  { id: "nara", goal: "Nara Park and Kasuga Taisha", days: ["day06"], status: "Ready", why: "Nara bridges Osaka and Kyoto with Todai-ji scale plus Kasuga Taisha's lantern forest, recommended by the Osaka friend.", blocker: "", fallback: "Use taxis and keep the visit to the park, Todai-ji approach, and one Kasuga lantern walk." },
  ...
  { id: "fuji-return", goal: "Protected Kawaguchiko–Tokyo return", days: ["day20"], status: "Needs Booking", why: "Returning on Nov 11 creates a full buffer before the flight and leaves time for missed Tokyo priorities. Parents fly home before this second Tokyo stay, so the landing is couple-only.", blocker: "Reserve the return bus or train and allow road-delay margin; finish canceling/rebooking the second KOKO parent room.", fallback: "Use the rail route via Otsuki if highway conditions look unreliable." },
  ...
  { id: "tokyo-story", goal: "Tokyo through Ghibli, Shibuya, friends, Asakusa, teamLab and food", days: ["day14", "day15", "day16", "day20", "day21"], status: "Ready", why: "Each Tokyo day has one distinct anchor, with Dad's Shibuya request and Mai's yose visit protected. Second Tokyo stay is couple-only after parents' earlier return.", blocker: "Cancel and redo Nov 11–13 as 1 room.", fallback: "Protect Ghibli, Shibuya Crossing, the evening with Akko, and Asakusa Engei Hall; trim shopping first." },
  ...
  { id: "pokemon-center", goal: "Mai's optional Pokémon Center visit", days: ["day14", "day16", "day21"], status: "Considering", why: "Mai is considering a Pokémon Center stop. Shibuya PARCO already holds Pokémon Center Shibuya on Day 16; Tokyo DX near Nihombashi is the hotel-neighborhood backup.", blocker: "Decide which branch fits energy; cafe reservations are separate and scarce.", fallback: "Skip without rebuilding the day; character browsing at PARCO or a short DX stop is enough." },
  { id: "teamlab", goal: "teamLab Borderless", days: ["day21"], status: "Needs Booking", why: "Mai already responded strongly to the visual experience. Final day is couple-only after parents' earlier return.", blocker: "Timed admission must be booked.", fallback: "Protect the chosen melon-bread store and final meal, then use another modern-art experience if desired." },
...
const regionalQuestPools = {
  ...
  nara: [
    ...
    ["nara-kasuga", "culture", "Walk Kasuga Taisha's lantern approaches, recommended by the Osaka friend."],
  ...
  tokyo: [
    ...
    ["tokyo-pokemon", "culture", "If Mai still wants it, visit one Pokémon Center—Shibuya inside PARCO or Tokyo DX near Nihombashi.", ["day14", "day16", "day21"]],
...
const tripData = {
  osaka: {
    ...
    description: "Arrival neon, maximum-pop Osaka with a local friend on Days 3–4, the scored snack mission, Kobe Nunobiki, and the Nara bridge via Kasuga Taisha.",
    ongoing: [
      {
    ...
    days: [
      ...
      questDay("day03", "2026-10-25", "Castle to Neon", "Monumental, pop-culture and retro-food Osaka in one strong arc—with our Osaka friend joining.", ["Osaka Castle", "Nippombashi Osaka", "Nipponbashi Denden Town", "Shinsekai Osaka"], "Meet the Osaka friend for the castle morning they offered to lead, eat a seated Nippombashi lunch, browse Den Den Town and reach Shinsekai for blue hour and kushikatsu.", ["Meet the Osaka friend (+81 90-3998-8613) near Osaka Castle", "Photograph the castle across the moat", "Choose the interior by interest", "Let the friend suggest one local stop if the pace allows", "Find one Den Den display that makes Mai stop", "Share one Osaka snack", "Finish with kushikatsu"], ["Golden castle ornament", "A character detail", "Tsutenkaku framed by signs"], "Mai gets history, games/anime culture and loud Osaka streets with a local guide.", "Parents choose Den Den or Shinsekai—not both; the friend may peel off before Shinsekai if the day runs long."),
      questDay("day04", "2026-10-26", "Kuromon Scores, Tenma Pours", "A timed, scored tasting route with a real finish line—and the Osaka friend available for a second day.", ["Kuromon Ichiba Market", "Daimaru Shinsaibashi", "Amerikamura", "Hotel Cordia Osaka Hommachi", "Tenma Osaka"], "Complete four shared Kuromon categories by 11:30, one Shinsaibashi food-hall checkpoint and one Amerikamura wildcard; reset at the hotel, then finish at no more than two Tenma venues. The Osaka friend can join whichever stretch fits their day.", ["Confirm whether the Osaka friend joins market morning or Tenma evening", "Score raw/seafood", "Score one hot or grilled bite", "Score one savory non-seafood bite", "Score one fruit or sweet", "Choose one food-hall checkpoint", "Use one Amerikamura wildcard", "Photograph each item and price", "Reset at the hotel", "Share plates at one Tenma izakaya", "Choose one optional specialist finish"], ["A market preparation detail", "The best value surprise", "A youth-culture snack or drink", "The Tenma dish worth reordering"], "Mai gets a playful food hunt rather than an aimless market wander, with optional local company.", "Parents use a seated Kuromon base, skip Amerikamura if useful and rejoin the first Tenma venue."),
      ...
      questDay("day06", "2026-10-28", "Deer to Kyoto", "Deer, giant Buddha, Kasuga lanterns, old streets, then Kyoto.", ["Kintetsu Nara Station", "Nara Park", "Todai-ji Temple", "Kasuga Taisha", "Naramachi", "Kyoto Station", "Hotel Monterey Kyoto"], "Use Nara as the Osaka-to-Kyoto bridge: Todai-ji for scale, then Kasuga Taisha for the lantern forest our Osaka friend recommended, before continuing to Kyoto.", ["Observe or feed deer without making them the entire day", "Enter Todai-ji's Great Buddha Hall", "Walk Kasuga Taisha's lantern approaches without collecting every hall", "Try yomogi mochi or kakinoha-zushi", "Find a cafe near Naramachi", "Make the luggage strategy feel competent"], ["A deer bow or side-eye", "A detail that makes Todai-ji's scale click", "Stone lanterns in a quiet Kasuga corridor", "An old-town shopfront"], "Mai gets iconic Nara plus one of Japan's most sacred lantern-lined shrines before Kyoto begins.", "Shorten Nara and reach Kyoto earlier if luggage or legs become the story; keep Todai-ji and one Kasuga lantern walk if choosing only two sights.")
    ]
  },
  kyoto: {
    name: "Kyoto",
  ...
  tokyo: {
    ...
    description: "Tokyo bookends a three-night Kawaguchiko retreat: settle in after Hiroshima with the parents, escape to Fuji with small bags, then return for a couple-only final Tokyo chapter after parents fly home.",
    ongoing: [
      {
    ...
    days: [
      ...
      questDay("day16", "2026-11-07", "Scramble Into Their Tokyo", "Give Dad his Shibuya moment, one Mai-friendly pop-culture stop, then protect the evening with Akko.", ["KOKO HOTEL Premier Nihonbashi Hamacho", "Shibuya Crossing", "Hachiko Statue", "Shibuya PARCO", "Pokémon Center Shibuya", "Akko meetup · provisional Chofu Station"], "Cross the Scramble, take the Hachiko photo, eat lunch nearby, choose one compact Mai stop—Pokémon Center Shibuya inside PARCO if she still wants it—and leave Shibuya by 15:30 for Akko's evening plan.", ["Cross Shibuya Crossing together", "Take Dad's Hachiko or crossing photo", "Choose one rooftop, cafe, or people-watching view", "Give Mai one focused PARCO / Pokémon Center stop if energy allows", "Leave by 15:30 for the confirmed meetup point", "Bring a small consumable thank-you gift for Akko"], ["Dad in the crossing", "Hachiko or Shibuya street texture", "A Pokémon Center detail if visited", "The relaxed group dinner with Akko"], "Dad gets his Tokyo icon and Mai gets one playful stop without exhausting the social evening.", "Cross once, take the photo, and skip PARCO/Pokémon Center if the meetup requires an earlier departure."),
      questDay("day17", "2026-11-08", "First Fuji Evening", "Tokyo intensity gives way to three quiet nights in a Kodachi villa beside Lake Kawaguchiko.", ["Shinjuku Station", "Kawaguchiko Station", "MIYA HOUSE Kodachi A棟"], "Leave the large luggage at KOKO, travel with small bags, taxi from Kawaguchiko Station to the villa after check-in opens, and watch the light change on Fuji. Parents may still join this Fuji chapter, but they fly home before the second Tokyo hotel stay.", ["Reserve the highway bus or Fuji Excursion", "Keep essential medication and layers in the small bag", "Taxi from Kawaguchiko Station to the villa (no property shuttle)", "Check in from 16:00; cook or eat nearby for dinner", "Confirm parents' Nov 11 departure plan so the second KOKO stay can be couple-only"], ["The first clear Fuji reveal", "Lake light from the terrace or shore", "A quiet arrival meal in the villa kitchen"], "Mai gets a deliberate Fuji escape rather than another complicated transfer chapter.", "Arrival, the view and dinner are the complete parent day—taxi from the station if the bus arrives before 16:00."),
      ...
      questDay("day20", "2026-11-11", "Back to Tokyo, Into the Yose", "Return from Fuji, reunite with the luggage, then give Mai a compact dose of old-school Japanese variety entertainment—couple-only after parents' earlier return.", ["MIYA HOUSE Kodachi A棟", "Kawaguchiko Station", "Shinjuku Station", "KOKO HOTEL Premier Nihonbashi Hamacho", "Asakusa Engei Hall"], "Take the protected morning return, recover the large bags into the rebooked couple-only KOKO room, then visit Asakusa Engei Hall for 60–90 minutes only if the transfer lands on time.", ["Taxi from the villa before the reserved departure", "Allow road-delay margin or use the Otsuki rail fallback", "Recover the large luggage into the 1-room Nov 11–13 booking", "Check the Asakusa Engei Hall bill and stage times", "Watch a compact rakugo or variety segment with Mai", "Eat an easy Asakusa or hotel-neighborhood dinner"], ["The last Fuji glimpse", "Suitcases reunited", "Asakusa yose curtain or lanterns"], "Mai gets a living traditional entertainment hall while the day still functions as a soft landing.", "If the Fuji return runs late, protect luggage and rest; Asakusa becomes optional."),
      questDay("day21", "2026-11-12", "Light, Melon Bread, Goodbye", "Immersive art, Mai's chosen bakery, final food and a fully packed suitcase—couple closing chapter.", ["KOKO HOTEL Premier Nihonbashi Hamacho", "teamLab Borderless Azabudai Hills", "Pokémon Center Tokyo DX", "Tokyo Melonpan", "Final Tokyo Dinner", "Tokyo Station"], "Visit teamLab at the booked time, optionally duck into Pokémon Center Tokyo DX near Nihombashi if Mai skipped Shibuya, make Mai's exact melon-bread shop a real stop, then finish with one celebratory meal and complete packing.", ["Find the teamLab room we most want to remember", "Take one abstract photo", "Use Pokémon Center Tokyo DX only if Mai still wants a Center and it fits between teamLab and bakery", "Confirm the exact bakery branch and stock", "Score the special melon bread in the passport", "Buy only the souvenirs still genuinely wanted", "Eat the final this-is-Tokyo meal", "Pack with airport margin", "Name the champion ekiben and melon bread"], ["A reflection that changes the room", "The first crackle of the special melon-bread crust", "One tiny goodbye photo"], "Mai chooses the sweet and emotional ending of the trip.", "Nothing else is required—skip Pokémon Center without rebuilding the day.")
    ]
  }
};
...
const dayGoals = {
  ...
  day03: {
    clearPath: "Meet Osaka friend at castle → Nippombashi lunch → Den Den → Shinsekai kushikatsu at blue hour.",
  ...
  day04: {
    clearPath: "Four Kuromon scores by 11:30, one food-hall stop, hotel reset, two-stop Tenma finish—friend optional.",
  ...
  day06: {
    clearPath: "Deer, Todai-ji, and Kasuga Taisha lanterns as the Nara bridge, then Kyoto check-in without luggage chaos.",
    mainGoal: "Stand inside Todai-ji's Great Buddha Hall, then walk one Kasuga lantern corridor.",
    photoHint: "The Buddha hall interior, stone lanterns at Kasuga, a deer moment, or old Naramachi lane."
  },
  day07: {
  ...
  day16: {
    clearPath: "Shibuya Crossing and Hachiko → lunch → one Mai stop (PARCO / Pokémon Center optional) → leave by 15:30 for Akko.",
    mainGoal: "Get Dad's crossing photo, then arrive relaxed and on time for the evening with Akko.",
    photoHint: "Dad in the crossing, Hachiko, Pokémon Center if visited, or the relaxed group dinner with Akko."
  },
  day17: {
  ...
  day20: {
    clearPath: "Early Fuji return → couple-only luggage recovery at rebooked KOKO → optional 60–90 minute Asakusa Engei Hall visit.",
    mainGoal: "Reunite with the luggage in the 1-room second Tokyo stay, then give Mai a compact yose experience if timing stays comfortable.",
    photoHint: "Suitcases reunited, Asakusa lanterns, or the Engei Hall curtain."
  },
  day21: {
    clearPath: "teamLab, optional Pokémon Center DX, Mai's melon-bread shop, final meal, suitcase fully packed.",
...
const legacyDayContext = {
  ...
  day03: {
    summary: "The maximum-pop Osaka day moves from the castle reveal—with our Osaka friend joining—through Den Den Town and into Shinsekai's retro-food glow.",
  ...
  day04: {
    summary: "Mai-centered snack mission, then Tenma izakaya dinner as the food capstone; the Osaka friend can join a second day.",
  ...
  day06: {
    summary: "Nara bridges Osaka and Kyoto: deer open the day, Todai-ji supplies the emotional scale, Kasuga Taisha adds the lantern forest, and luggage never becomes the main character.",
    history: "Nara became Japan's first lasting imperial capital in 710. Todai-ji's Great Buddha was cast in the 8th century as a unifying act of protection during political anxiety; Kasuga Taisha is famed for thousands of donated stone and bronze lanterns."
  },
  day07: {
  ...
  day16: {
    summary: "Dad's Shibuya Crossing anchors the morning; one Mai-friendly stop—optionally Pokémon Center Shibuya inside PARCO—follows, then the schedule clears for the evening with Akko.",
  ...
  day17: {
    summary: "Everyone who is still on the trip leaves Tokyo with small bags for three nights in the confirmed Kodachi villa beside Lake Kawaguchiko; parents fly home before the second Tokyo hotel stay.",
...
const dayContext = {
  ...
  day03: {
    summary: "Castle, character culture and retro food give Osaka one intentionally big day—with our Osaka friend joining from the castle morning they offered to lead. Do not add a fourth district; the arc works because each stop has a different emotional register. Parents can skip the castle interior or shorten Den Den and still meet at Shinsekai for the shared evening finish.",
    timeline: [["08:30–11:30", "Meet the Osaka friend (+81 90-3998-8613) near Osaka Castle; enjoy the reveal and choose the interior by interest."], ["11:30–13:00", "Travel south and sit for a substantial Nippombashi lunch; the friend can stay or peel off by energy."], ["13:00–16:00", "Browse a defined Den Den Town segment."], ["16:00–19:30", "Continue to Shinsekai for blue-hour signs and kushikatsu; add no fourth district."]],
    history: [
      ...
      "Put together, the day moves through three different Osaka moods: political power, hobby obsession, and retro street theatre. Local company for the castle morning turns the first big sightseeing day into hospitality rather than a pure checklist."
    ]
  },
  day04: {
    summary: "The Osaka Snack League turns Kuromon, Shinsaibashi and Amerikamura into a bounded five-taste quest before a protected Tenma dinner. The Osaka friend said they can also join on the 26th—confirm market morning versus Tenma evening so the scorecard stays intact. Four Kuromon categories by 11:30, one depachika checkpoint, one Amerikamura wildcard, then a real hotel reset before izakaya.",
    timeline: [["10:00–11:30", "At Kuromon, share and score exactly four categories: raw/seafood, hot/grilled, savory non-seafood and fruit/sweet. Hard exit at 11:30. Friend optional."], ["12:00–14:30", "Use Daimaru Shinsaibashi for one controlled food-hall checkpoint and seating; continue to Amerikamura for one wildcard only."], ["15:00–17:00", "Return to the Namba hotel for a real reset and stop eating."], ["17:30–21:00", "Go to Tenma: one izakaya for shared plates, then at most one specialist negiyaki, ramen, gyoza or dessert finish. Friend can rejoin for dinner."]],
    history: [
  ...
  day06: {
    summary: "Nara becomes the bridge from Osaka to Kyoto: deer open the day, Todai-ji supplies the emotional scale, Kasuga Taisha adds the lantern forest our Osaka friend recommended, and luggage never becomes the main character. Travel with day bags only, keep deer encounters playful but brief, and treat Todai-ji plus one Kasuga lantern walk as the complete sacred pair before Kyoto.",
    timeline: [["08:00–09:00", "Check out and send or store luggage; travel toward Kintetsu Nara."], ["10:00–12:30", "Walk or taxi through Nara Park toward Todai-ji, keeping deer encounters playful but brief."], ["12:30–14:30", "Enter the Great Buddha Hall, then continue to Kasuga Taisha for one lantern-lined approach without collecting every hall."], ["14:30–15:30", "Eat kakinoha-zushi or mochi, then choose a short Naramachi or cafe pause."], ["15:30–18:00", "Continue to Kyoto. Attempt To-ji only if everyone is luggage-free by about 15:45; otherwise check in and eat near the hotel."]],
    history: [
      ...
      "Kasuga Taisha, one of Japan's most sacred Shinto shrines, is famous for thousands of stone and bronze lanterns donated over centuries—exactly the lantern forest our Osaka friend recommended. The deer of Nara Park belong to the same sacred landscape; Naramachi's merchant lanes then carry the day toward Kyoto."
    ]
  },
  day07: {
  ...
  day16: {
    summary: "Dad's Shibuya Crossing is the morning anchor, with Hachiko, lunch and one focused Mai-friendly stop—Pokémon Center Shibuya inside PARCO if she still wants it—before a hard 15:30 departure for Akko. Do not turn Shibuya into a full shopping marathon—the evening meetup is the capstone and should begin without anyone already exhausted.",
    timeline: [["09:30–10:30", "Travel from KOKO Hamacho to Shibuya; no early alarm after the Ghibli day."], ["10:30–11:15", "See Hachiko, cross the Scramble, watch one full signal cycle, and take Dad's group photo."], ["11:15–13:30", "Have a seated lunch, then choose exactly one Mai-facing stop; Pokémon Center Shibuya inside PARCO is the default if she wants a Center."], ["13:30–15:15", "Use a cafe/rest buffer or one short Shibuya browse—do not add Harajuku."], ["By 15:30", "Depart directly for Akko's confirmed meeting point; leave earlier if the location is farther away."], ["Evening", "Let Akko choose the neighborhood and dinner; keep it seated, social and unhurried."]],
    history: [
  ...
  day17: {
    summary: "Begin a three-night Kawaguchiko retreat with small bags while the large luggage stays at KOKO's front desk between the two Tokyo stays. Parents may still join the Fuji chapter, but their return tickets land before the second Tokyo hotel—cancel their Nov 11–13 room and rebook couple-only. Send or store large luggage, reserve the highway bus or Fuji Excursion, and taxi from Kawaguchiko Station to MIYA HOUSE Kodachi A棟 once check-in opens at 16:00.",
  ...
  day21: {
    summary: "The final full day protects three things only: teamLab, Mai's chosen special melon bread, and a fully packed, well-fed ending—now a couple closing chapter. Visit Borderless with generous admission margin; use Pokémon Center Tokyo DX near Nihombashi only if Mai skipped Shibuya and still wants a Center. Confirm the exact melon-bread branch and stock before the last afternoon.",
    timeline: [["Morning", "Use a morning teamLab time if available and travel with generous admission margin."], ["Timed entry–3 hours", "Explore Borderless without trying to locate every room; use the tea house or Azabudai for a reset."], ["Mid-afternoon–18:00", "Optional short stop at Pokémon Center Tokyo DX only if Mai still wants it; then go to Mai's exact melon-bread shop and complete the final passport score; handle only essential souvenirs."], ["18:00–21:00", "Eat the final celebratory meal, name the ekiben and melon-bread champions, and pack completely."]],
    history: [
      ...
      "The last full day is structured like a closing ceremony: one immersive room to remember, one flavour to carry home, one meal to mark the couple, and a suitcase that leaves nothing important behind. Tokyo does not need another district added—only these anchors done well."
    ]
  }
};
...
const CITY_FOOD_MAP_PROTOTYPE = {
  ...
  kyoto: [
    ...
    { name: "Nishiki Gyoza", type: "restaurant", category: "gyoza", typeLabel: "Handmade gyoza · Nishiki pick", area: "Day 9 · Nishiki Market", price: "¥", note: "The market's handmade gyoza specialist—plump Tanba-pork dumplings with Kyoto shichimi yuzu and red-miso dipping sauces. Share one order standing or at the tiny counter; do not turn it into a second full meal after other Nishiki tastes.", coordinates: [35.00502, 135.76435], officialUrl: "https://www.kyoto-nishiki.or.jp/en/stores/nishikigyoza/" },
  ...
  tokyo: [
    ...
    { name: "Ningyocho Imahan Main Store", type: "restaurant", category: "sukiyaki", typeLabel: "Sukiyaki · final-dinner candidate", area: "Hotel base · Ningyocho", price: "¥¥¥¥", note: "A historic, reservation-worthy wagyu sukiyaki meal only a few minutes from the hotel. Best as a family dinner on the first Tokyo stay, or as the couple's celebratory final meal after parents fly home before the second stay.", coordinates: [35.68577, 139.78349], officialUrl: "https://imahan-tokyo.com/official/" },
    ...
    { name: "Boulangerie Le Cinq", type: "cafe", category: "cafe", typeLabel: "Zero-travel bakery café", area: "Inside KOKO Hotel · 1F", price: "¥¥", note: "The hotel's own bakery and easiest breakfast reset. Use it on a transfer morning or when anyone wants a proper seat without beginning another neighborhood mission.", coordinates: [35.68722, 139.78737], officialUrl: "https://www.boulangerie-le-cinq.com/pages/%E3%83%AB%E3%82%B5%E3%83%B3%E3%82%AF-%E3%82%A2%E3%82%AF%E3%82%BB%E3%82%B9" },
...
const placeBackground = {
  ...
  "Nara Park": "Nara Park preserves a landscape where deer, temples and open grass have coexisted for centuries. Keep deer encounters playful and brief—they open the day, but Todai-ji's scale and Kasuga's lanterns are the sacred payoffs.",
  ...
  "Kasuga Taisha": "Kasuga Taisha is one of Japan's most sacred Shinto shrines, best known for thousands of stone and bronze lanterns donated over hundreds of years—the lantern forest our Osaka friend recommended. Walk one lantern approach without collecting every hall; atmosphere matters more than completion.",
  ...
  "KOKO HOTEL Premier Nihonbashi Hamacho": "KOKO HOTEL Premier Nihonbashi Hamacho is your confirmed Tokyo base for both stays (Nov 5–8 and Nov 11–13). One minute from Hamacho Station on the Toei Shinjuku Line—direct to Shinjuku for the Fuji bus—and six minutes from Ningyocho on the Hibiya Line. Leave large bags at the front desk between stays during the Kawaguchiko gap. Parents fly home before the second stay—cancel their Nov 11–13 room and rebook as 1 couple-only room.",
  ...
  "Shibuya PARCO": "Shibuya PARCO stacks fashion, character goods and pop-culture floors above the Scramble. It is Mai's default one-stop character browse—and the building that houses Pokémon Center Shibuya—so keep it compact enough to protect the 15:30 Akko departure.",
  "Pokémon Center Shibuya": "Pokémon Center Shibuya occupies the 6th floor of Shibuya PARCO and is the natural Day 16 branch if Mai wants a Center without adding a separate district. Browse once, buy only what she genuinely wants, and leave margin for Akko—skip without rebuilding the day if queues or energy say no.",
  "Pokémon Center Tokyo DX": "Pokémon Center Tokyo DX sits on the 5th floor of Nihombashi Takashimaya S.C. East Building, a short walk from Tokyo Station and practical from the Hamacho hotel. Use it as the hotel-neighborhood backup if Mai skips the Shibuya branch; the attached Pokémon Cafe needs a separate scarce reservation and is not required.",
