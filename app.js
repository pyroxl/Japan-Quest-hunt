...
const APP_VERSION = "japan-quest-v156";
...
const RESERVATION_COUNTDOWN = [
  ...
  { name: "Tempura Yasaka Endo", recommendedOn: "2026-08-03", target: "Oct 29 dinner", note: "Parents' Gion dinner. Day 7 already ends at Yasaka/Gion—book 17:00 or 17:30 for four. Open year-round; dinner courses about ¥16,000–33,000 plus service. If keeping Gion Corner at 18:00, use Endo lunch instead or a 19:30 dinner after the show.", url: "https://www.gion-endo.com/" },
  { name: "Gion Corner", recommendedOn: "2026-08-01", target: "Oct 29 at 18:00", note: "Only if Endo is lunch or a late dinner. An 18:00 show conflicts with a normal Endo dinner seating.", url: "https://www.kyoto-gioncorner.com/global/en.html" },
...
const tripData = {
  ...
  kyoto: {
    ...
    days: [
      questDay("day07", "2026-10-29", "Torii to Old Kyoto", "An energetic southeast-to-north sweep from Mt Inari to Kiyomizu and Gion.", ["Fushimi Inari Taisha", "Yotsutsuji Intersection Kyoto", "Tofuku-ji Temple", "Kiyomizu-dera", "Sannenzaka", "Ninenzaka", "Yasaka Shrine", "Gion Kyoto"], "Mai and Brian climb Fushimi Inari early, make one compact Tofuku-ji visit, then meet the parents near Kiyomizu and follow the old streets downhill to Gion for the reserved Tempura Yasaka Endo dinner.", ["Turn around at Yotsutsuji or sooner", "Choose either Tofuku-ji's garden or Tsutenkyo area", "Meet the parents near Kiyomizu around 10:30", "Find one matcha or wagashi pause", "Be near Yasaka/Gion by late afternoon for the Endo dinner seating"], ["A fox detail", "Kyoto spreading out below Mt Inari", "The Kiyomizu panorama", "A sloping-street detail"], "Mai gets torii, old streets and the dream-trip Kyoto view in one coherent corridor.", "Parents skip Inari and Tofuku-ji, taxi toward Kiyomizu, and use a cafe base."),
...
const CITY_FOOD_MAP_PROTOTYPE = {
  ...
  kyoto: [
    ...
    { name: "Tempura Yasaka Endo", type: "restaurant", category: "kyoto-tempura", typeLabel: "Kyoto tempura · parents' dinner", area: "Day 7 · Yasaka-dori / Kennin-ji", price: "¥¥¥¥", note: "The protected Day 7 dinner: Kyoto-style tempura kaiseki on Yasaka-dori beside Kennin-ji and Yasaka Pagoda. Open year-round; book 17:00 or 17:30 for four. Lunch (¥7,700–11,000) works only if Gion Corner stays at 18:00.", coordinates: [34.99887, 135.77554], officialUrl: "https://www.gion-endo.com/" },
    { name: "Sohonke Nishin Soba Matsuba Honten", type: "restaurant", category: "nishin-soba", typeLabel: "Nishin soba · must try", area: "Day 7 · Gion-Shijo / Minamiza", price: "¥¥", note: "Kyoto's signature buckwheat noodles with sweet-simmered herring, served where the dish originated. Use as a lighter Day 7 lunch or backup if Endo is unavailable.", coordinates: [35.00365, 135.77262], officialUrl: "https://sobamatsuba.co.jp/menu/access.html" },
    { name: "Izuju", type: "restaurant", category: "kyoto-sushi", typeLabel: "Saba-zushi · high priority", area: "Day 7 · Yasaka Shrine", price: "¥¥¥", note: "Traditional Kyoto pressed sushi beside Yasaka. Share saba-zushi or hako-zushi as a tasting; current last order is early enough that this is lunch, not a replacement for Endo dinner.", coordinates: [35.00362, 135.77853], officialUrl: "https://gion-izuju.com/english-page/" },
    { name: "Kiyomizu Junsei Okabeya", type: "restaurant", category: "tofu-yuba", typeLabel: "Yudofu & yuba · route pick", area: "Day 7 · Kiyomizu-dera approach", price: "¥¥¥", note: "The most practical tofu meal on this itinerary: yudofu and fresh yuba directly on the Kiyomizu route. Use it as the seated lunch while Endo holds the evening.", coordinates: [34.99616, 135.78082], officialUrl: "https://www.okabeya.com/lang/en.html" },
...
const KYOTO_FOOD_CATEGORIES = {
  ...
  "kyoto-tempura": { label: "Kyoto tempura", icon: "🍤" },
