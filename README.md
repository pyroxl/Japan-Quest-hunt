...
The app works offline and therefore uses a service-worker cache. This update uses cache `japan-quest-v21` and asks the new worker to activate immediately. If an already-open tab still shows the old route:
